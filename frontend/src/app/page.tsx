      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-text {
          ...
          background: linear-gradient(90deg, #e8e6e0, #a09fad);
          -webkit-background-clip: text; -webkit-text-fill-color: transparent;
        }

        .tagline {
          font-family: 'DM Mono', monospace;
          font-size: 13px; color: #6b6a75; letter-spacing: 0.02em;
        }
        ...
        .upload-title {
          font-size: 17px; font-weight: 600; color: #e8e6e0; margin-bottom: 8px;
        }

        .upload-sub {
          font-family: 'DM Mono', monospace;
          font-size: 12px; color: #6b6a75;
        }
        ...
        .error-box {
          ...
          font-family: 'DM Mono', monospace; font-size: 12px; color: #FF6B6B;
          margin-top: 12px;
        }
        ...
        .card-label {
          font-family: 'DM Mono', monospace;
          font-size: 10px; color: #6b6a75;
          letter-spacing: 0.1em; text-transform: uppercase;
          margin-bottom: 8px;
        }

        .card-value {
          font-size: 14px; color: #e8e6e0; line-height: 1.6;
        }

        .hash-value {
          font-family: 'DM Mono', monospace;
          font-size: 11px; color: #a09fad;
        ...
        .points-list li {
          ...
          font-size: 13px; color: #c4c2cc; line-height: 1.6;
          padding: 6px 0;
          border-bottom: 1px solid rgba(255,255,255,0.04);
        }
        .points-list li:last-child { border-bottom: none; }
        .points-list li::before {
          content: '→'; color: #6366f1; font-family: 'DM Mono', monospace;
        ...
        .storage-link {
          ...
          color: #6366f1; word-break: break-all; line-height: 1.6;
        ...
        .stat-label {
          font-size: 11px; color: #6b6a75; margin-top: 2px;
        ...
        {result && cfg && (
          <div className="results">
            ...
            <div className="card" style={{ borderColor: 'rgba(99,102,241,0.2)', background: 'rgba(99,102,241,0.04)' }}>
              <div className="card-label" style={{ color: '#6366f1' }}>Blockchain Status</div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 4 }}>
                <div style={{ width: 8, height: 8, borderRadius: '50%', background: '#FFE66D', boxShadow: '0 0 8px #FFE66D' }} />
                <span style={{ fontSize: 13, color: '#a09fad', fontFamily: 'DM Mono, monospace' }}>
                  Phase 4 — blockchain verification coming soon
                </span>
              </div>
            </div>
          </div>
